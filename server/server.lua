...
-------------------------------------
--- Change Horse System
RegisterNetEvent('rsg-horses:server:changehorseModel', function(data)
    local src = source

    Config.HorseSettings[data.horsesettingskey].horsemodel = data.newmodel
    Config.HorseSettings[data.horsesettingskey].horseprice = data.newprice
    Config.HorseSettings[data.horsesettingskey].horsename = data.newname



end)

RegisterNetEvent('rsg-horses:server:changehorse', function(data)
    --print(json.encode(data))
    TriggerClientEvent('rsg-horses:client:changeHorses', -1, data)
